...
def names_mapping():
    mapping = {'artifacts_size': 'Storage: artifacts size',
               ...
               'artifacts_count_monthly_growth': 'Artifacts count monthly incline',
               'artifacts_size_monthly_growth': 'Artifacts size monthly incline',
               'binaries_count_monthly_growth': 'Binaries count monthly incline',
               'binaries_size_monthly_growth': 'Binaries size monthly incline',
               'items_count_monthly_growth': 'Items count monthly incline',
               ...
               'binaries_size_quarter_growth': 'Binaries size quarterly incline',
               'items_count_quarter_growth': 'Items count quarterly incline',
